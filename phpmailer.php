...
{
	$loginid 	= "onlineauction@myprojectcoding.xyz";
	$password 	= "A+?c_)rM1,M5";
	$smtpserver = "mail.myprojectcoding.xyz";
	$smtpport 	= 26;
	$mailsender = "onlineauction";
	$companyname= "onlineauction";
	$facebook = "https://www.facebook.com/haraaj.in";
	$twitter = "https://www.twitter.com/haraaj.in";
	$youtube = "https://www.youtube.com/haraaj.in";
	$linkedin = "https://www.linkedin.com/haraaj.in";
	$companyaddress  = "haraaj.in, 9-57, Wadi-e-Hadees, Hyderabad-500005, India | Email us: hyd2050@gmail.com";
